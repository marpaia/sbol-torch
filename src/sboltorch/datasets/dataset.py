"""Torch Dataset and padding collator over encoded SbolObjects."""
...
class EncodedDataset(Dataset):
    """Lazily encodes SbolObjects on ``__getitem__``.
    ...
    def __init__(self, objects: Sequence[SbolObject], encoder: SupportsEncode) -> None:
